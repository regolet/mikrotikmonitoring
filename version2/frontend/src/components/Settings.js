...
function Settings() {
  ...
  const handleAddRouter = async (e) => {
    ...
    try {
      ...
      showError('Add Error', err.response?.data?.error || 'Failed to add router');
    }
  };
  ...
  const handleEditRouter = async (e) => {
    ...
    try {
      ...
      setRouters((prev) => prev.map(r => r.id === editRouter.id ? res.data.router : r));
      closeModals();
      showSuccess('Router Updated', 'Router updated successfully');
    } catch (err) {
      showError('Update Error', err.response?.data?.error || 'Failed to update router');
    }
  };
  ...
  const handleDeleteRouter = async (id) => {
    ...
    try {
      ...
      showError('Delete Error', err.response?.data?.error || 'Failed to delete router');
    } finally {
  ...
  const handleTestRouterConnection = async (routerId) => {
    ...
    try {
      ...
      if (res.data.success && res.data.connected) {
        showSuccess('Connection Test', `Successfully connected to ${res.data.router_name}`);
      } else {
        showError('Connection Test', res.data.error || 'Failed to connect to router');
      }
    } catch (err) {
      ...
      <div className="card mb-4">
        ...
        <div className="card-body">
          <div className="table-responsive">
            <table className="table table-striped table-hover" id="routers-table">
              <thead>
                <tr>
                  <th>Name</th>
                  <th>Host</th>
              ...
              <tbody>
                {routers.length === 0 ? (
                  <tr><td colSpan="5" className="text-center text-muted">No routers configured</td></tr>
                ) : (
                  routers.map((router) => (
                    <tr key={router.id}>
                      <td>{router.name}</td>
                      <td>{router.host}</td>
                      <td>
                        <i className={`bi ${getStatusIcon(router.connection_status)} ${getStatusClass(router.connection_status)}`}></i>
                      ...
                      <td>
                        <div className="btn-group btn-group-sm">
                          <button 
                            ...
                            onClick={() => handleTestRouterConnection(router.id)}
            ...
            <div className="modal-content">
              ...
              <form onSubmit={handleAddRouter}>
                <div className="modal-body">
                  <div className="mb-3">
                    <label htmlFor="router-name" className="form-label">Router Name</label>
                    <input 
                      type="text" 
                  ...
                  <div className="mb-3">
                    <label htmlFor="router-description" className="form-label">Description</label>
                    <input 
                      type="text" 
                      className="form-control" 
                      name="description" 
                  ...
                  <div className="row">
                    <div className="col-md-8">
                      <div className="mb-3">
                        <label htmlFor="router-host" className="form-label">Host/IP Address</label>
                        <input 
                          type="text" 
                          className="form-control" 
                          name="host" 
                    ...
                    <div className="col-md-4">
                      <div className="mb-3">
                        <label htmlFor="router-port" className="form-label">Port</label>
                        <input 
                          type="number" 
                          className="form-control" 
                          name="port" 
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label htmlFor="router-username" className="form-label">Username</label>
                        <input 
                          type="text" 
                          className="form-control" 
                          name="username" 
                    ...
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label htmlFor="router-password" className="form-label">Password</label>
                        <input 
                          type="password" 
                          className="form-control" 
                          name="password" 
                ...
                <div className="modal-footer">
                  ...
                  <button type="submit" className="btn btn-primary">Save Router</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <form onSubmit={handleEditRouter}>
                <div className="modal-body">
                  <input type="hidden" name="edit-router-id" value={editRouter?.id || ''} />
                  <div className="mb-3">
                    <label htmlFor="edit-router-name" className="form-label">Router Name</label>
                    <input 
                      type="text" 
                      className="form-control" 
                      name="name" 
                  ...
                  <div className="mb-3">
                    <label htmlFor="edit-router-description" className="form-label">Description</label>
                    <input 
                      type="text" 
                      className="form-control" 
                      name="description" 
                  ...
                  <div className="row">
                    <div className="col-md-8">
                      <div className="mb-3">
                        <label htmlFor="edit-router-host" className="form-label">Host/IP Address</label>
                        <input 
                          type="text" 
                          className="form-control" 
                          name="host" 
                    ...
                    <div className="col-md-4">
                      <div className="mb-3">
                        <label htmlFor="edit-router-port" className="form-label">Port</label>
                        <input 
                          type="number" 
                          className="form-control" 
                          name="port" 
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label htmlFor="edit-router-username" className="form-label">Username</label>
                        <input 
                          type="text" 
                          className="form-control" 
                          name="username" 
                    ...
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label htmlFor="edit-router-password" className="form-label">Password</label>
                        <input 
                          type="password" 
                          className="form-control" 
                          name="password" 
                  ...
                  <div className="mb-3">
                    <div className="form-check">
                      <input 
                        ...
                        id="edit-router-ssl" 
                      />
                      <label className="form-check-label" htmlFor="edit-router-ssl">
                        Use SSL/TLS
                      </label>
                    </div>
                  </div>
                ...
                <div className="modal-footer">
                  <button type="button" className="btn btn-secondary" onClick={closeModals}>Cancel</button>
                  <button type="submit" className="btn btn-primary">Update Router</button>
                </div>
              </form>
            </div>
          </div>
